    ...
    >
      <div className="container mx-auto px-4 mb-8 text-center">
        ...
        <div className="relative mb-12 max-w-5xl mx-auto mt-5">
          <div className="block aspect-[16/12] sm:aspect-[21/8] w-full relative rounded-2xl overflow-hidden">
            <Image
            ...
            />
            <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-0 sm:inset-auto sm:left-8 sm:top-1/2 sm:-translate-y-1/2 sm:max-w-md bg-sage-700/90 backdrop-blur-sm p-4 sm:p-5 rounded-2xl shadow-xl w-full sm:m-0">
              <BodyText variant="dark-bg" size="lg" colour="cream">
                <strong className="highlight-text-dark">
                  Solution Focused Hypnotherapy
                </strong>{" "}
                is a forward-looking approach. Rather than dwelling on the past,
                it encourages you to
                <em className="emphasis-text-dark">
                  {" "}
                  imagine the future you want
                </em>
                , then helps you take steps to get there. The therapist will ask{" "}
