    ...
    <>
      ...
      <section
        ...
        <h2 id="solution-list-heading" className="sr-only">
          Solution Focussed Hypnotherapy Areas
        </h2>
        <Title size="3xl" colour="forest" weight="bold">
          Solution Focussed Hypnotherapy can help you with:
        </Title>

        <nav aria-label="Solution Focussed Hypnotherapy areas navigation">
          <ul
            ...
            {treatmentAreas.map((area, index) => (
              <li key={area.name + index}>
                <Link
                  ...
                  aria-label={`Learn more about ${area.name} solution focussed hypnotherapy`}>
