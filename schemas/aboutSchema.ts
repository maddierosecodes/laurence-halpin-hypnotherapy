export const aboutSchema = {
  ...
  '@type': 'AboutPage',
  name: 'About Laurence Halpin | Professional Hypnotherapist in Chorley',
  description:
    'Meet Laurence Halpin, a professional hypnotherapist with over 30 years of mental health experience. Specialising in solution-focused hypnotherapy for anxiety, stress, phobias, and more in Chorley and surrounding areas.',
  ...
  mainEntity: {
    ...
    description:
      'Over 30 years of mental health experience, specialising in solution-focused hypnotherapy.',
